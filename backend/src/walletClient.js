...
//   caller-supplied value. A prediction market or vault flow that accepts
//   an address as input is a direct path to draining the wallet into an
//   attacker's contract. If a second chain or a second Aave deployment is
//   ever added, add it here explicitly rather than making the address a
//   parameter.
...
// wallet's spendable balance, where it becomes wagerable yield. Never
// touches principal.
